...
def load_lottie_url(url: str) -> Any:
...
def find_project_id(source: list[Any], selected_project: str) -> Any:
...
def make_persons_list(source: list[Any]) -> list[Any]:
...
def find_person_id(source: list[Any], selected_person: str) -> Any:
...
def assignees_to_df(all_assignees: list[Any]) -> pd.DataFrame:
...
def managers_to_df(all_managers: list[Any]) -> pd.DataFrame:
...
def projects_to_df(all_projects: list[Any]) -> pd.DataFrame:
...
def tasks_to_df(all_tasks: list[Any]) -> pd.DataFrame:
...
def assignees_to_chart(all_assignees: list[Any]) -> pd.DataFrame:
